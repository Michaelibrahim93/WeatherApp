 ...
 *
 * Unless required sortBy applicable law or agreed to in writing, software
 ...
 * OkHttpClient#networkInterceptors() network interceptor}. <p> The format of the logs created sortBy
 * this class should not be considered stable and may change slightly between releases. If you need
 * a stable logging format, use your own interceptor.
 */
public final class HttpLoggingInterceptor implements Interceptor {
    private static final Charset UTF8 = Charset.forName("UTF-8");
    private static final String ERORR="ERROR";
    public enum Level {
        /** No logs. */
        NONE,
        /**
